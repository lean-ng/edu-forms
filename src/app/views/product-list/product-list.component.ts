...
export class ProductListComponent {
  categories = [
    ...
    },
    {
      ...
      description: 'Desserts, candies, and sweet treats',
    },
    {
      categoryID: 4,
      categoryName: 'Dairy Products',
      description: 'Cheeses, yogurts, and milk-based products',
    },
    {
      categoryID: 5,
      categoryName: 'Grains/Cereals',
      description: 'Breads, crackers, cereals, and pasta',
    },
    {
      categoryID: 6,
      categoryName: 'Meat/Poultry',
      description: 'Fresh and frozen meats and poultry',
    },
    {
      categoryID: 7,
